export const brandAssets = {
  aboutBackground: "./photo-web/AboutMe/IMG_5599.jpg",
  heroBackground: "./photo-web/Car/J7402839.jpg",
  heroVideo: new URL("../../../background loop.mp4", import.meta.url).href,
  loadingVideo: new URL("../../../LoadingScreen.mp4", import.meta.url).href,
  logoDark: "./portfolio-assets/logo-dark.png",
  logoLight: "./portfolio-assets/logo-white.png",
  reelSurface: "./portfolio-assets/reel-surface.png",
} as const;
